...
This implementation support .Net 3.5 and above as well as the .Net Compact Framework for use under Windows CE.

Liquid Fast Infoset was written as a commercial product by Liquid Technologies Limited, and is now been released for use
in Open Source projects under the GNU Affero General Public License:
